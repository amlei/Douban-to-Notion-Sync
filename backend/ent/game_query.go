...
func (_q *GameQuery) FirstID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (_q *GameQuery) FirstIDX(ctx context.Context) int64 {
...
func (_q *GameQuery) OnlyID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (_q *GameQuery) OnlyIDX(ctx context.Context) int64 {
...
func (_q *GameQuery) IDs(ctx context.Context) (ids []int64, err error) {
...
func (_q *GameQuery) IDsX(ctx context.Context) []int64 {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *GameQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(game.Table, game.Columns, sqlgraph.NewFieldSpec(game.FieldID, field.TypeInt64))
	_spec.From = _q.sql

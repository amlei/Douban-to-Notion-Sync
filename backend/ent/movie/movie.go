...
const (
	...
	FieldRating = "rating"
	// FieldWatchDate holds the string denoting the watch_date field in the database.
	FieldWatchDate = "watch_date"
...
// ByWatchDate orders the results by the watch_date field.
func ByWatchDate(opts ...sql.OrderTermOption) OrderOption {
	return sql.OrderByField(FieldWatchDate, opts...).ToFunc()
}

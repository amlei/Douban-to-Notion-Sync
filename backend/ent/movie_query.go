...
func (_q *MovieQuery) FirstID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (_q *MovieQuery) FirstIDX(ctx context.Context) int64 {
...
func (_q *MovieQuery) OnlyID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (_q *MovieQuery) OnlyIDX(ctx context.Context) int64 {
...
func (_q *MovieQuery) IDs(ctx context.Context) (ids []int64, err error) {
...
func (_q *MovieQuery) IDsX(ctx context.Context) []int64 {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}

...
func (_q *NoteQuery) FirstID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (_q *NoteQuery) FirstIDX(ctx context.Context) int64 {
...
func (_q *NoteQuery) OnlyID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (_q *NoteQuery) OnlyIDX(ctx context.Context) int64 {
...
func (_q *NoteQuery) IDs(ctx context.Context) (ids []int64, err error) {
...
func (_q *NoteQuery) IDsX(ctx context.Context) []int64 {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *NoteQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(note.Table, note.Columns, sqlgraph.NewFieldSpec(note.FieldID, field.TypeInt64))
	_spec.From = _q.sql

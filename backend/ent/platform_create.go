...
func (_c *PlatformCreate) SetID(v int) *PlatformCreate {
	_c.mutation.SetID(v)
	return _c
}
...
func (_c *PlatformCreate) check() error {
	...
	if v, ok := _c.mutation.ID(); ok {
		if err := platform.IDValidator(v); err != nil {
			return &ValidationError{Name: "id", err: fmt.Errorf(`ent: validator failed for field "Platform.id": %w`, err)}
		}
	}
	return nil
}
